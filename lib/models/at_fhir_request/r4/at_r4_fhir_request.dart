...
class AtR4FhirRequest with _$AtR4FhirRequest {
  ...
  const factory AtR4FhirRequest.error({
  ...
  factory AtR4FhirRequest.fromJson(Map<String, dynamic> json) =>
      _$AtR4FhirRequestFromJson(json);

  /// Acts like a constructor, returns a [AtR4FhirRequest], accepts a
  /// [String] as an argument, mostly because I got tired of typing it out
  factory AtR4FhirRequest.fromJsonString(String source) {
    final dynamic json = jsonDecode(source);
    if (json is Map<String, dynamic>) {
      return _$AtR4FhirRequestFromJson(json);
    } else {
  ...
  factory AtR4FhirRequest.fromFhirRequest(
    FhirRequest request,
